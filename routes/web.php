...
//Route pour l'envoi pour les requêtes Ajax
...
//Route pour l'espace d'administration
Route::prefix('admin')->middleware('admin')->group( function () {
    Route::get('/', 'AdminController@index')->name('admin.index');

    //Route pour les annonces obsolètes (Affichage des annonces obsolètes)
    Route::prefix('annonces')->group(function () {
        Route::get('obsoletes', 'AdminController@obsoletes')->name('admin.obsoletes');
    });

    //Route de moderation des message
    ...
    //Modération pour l'accès à la liste des annonces, approbation et refus
    Route::prefix('annonces')->group(function () {
    ...
    //Route pour les annonces obsolètes (prolonge la semaine d'une annonce et suppression définitive)
...
//Route de gestion d'interface utilisateur
