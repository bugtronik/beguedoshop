...
class AdController extends Controller
{
     ...
     */
    public function index(Request $request, $regionSlug = null)
    {
        ...
        return view('adsvue', compact('categories', 'regions', 'region', 'page'));
    }
    ...
    public function update(AdUpdate $request, Ad $ad)
    {
        ...
        $request->session()->flash('status', "L'annonce a été bien modifiée");
